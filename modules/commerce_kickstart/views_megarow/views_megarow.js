...
(function ($) {
  ...
  /**
   * AJAX responder command to place HTML within the megarow.
   */
  ...
  /**
   * AJAX responder command to dismiss the megarow.
   */
  ...
  /**
   * AJAX responder command to refresh the parent row of a megarow.
   */
